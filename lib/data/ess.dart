...
String work='''
      #italic##bold##size30#What is work worth doing?#/italic##/bold##size20#

      It seems like a fundamental question but in a world where everyone is just trying to get by, few have the luxury or desire to take the time to ask. Additionally, the answer to those that ask can't be a comfortable one, since it forces us to question our own lives and values. Since I'm currently 23 years old, I believe that facing the void to ask this question now is well worth the risk, given the alternative of a meaningless life. 
      To answer this question, we must first dig into what motivates people to do the work they do now. I believe most people rather as "will this work be rewarded?" when chosing what work to do.
      This reward mentality is drilled into us from birth. The pursuit of  external validate, from grades, money, status etc
      I'd like to first dig into why so often the means become the ends in civilized society. Next I'll analyze those who have broken from this mold to find clues for us. Then I will go into what I believe I and others should do in the situation we are in. And finally I will hypothesis potential solutions.
      "On liberty quote" 
      As a species, we have been able to run earth because of our ability to "predict the future" or more specifically, our ability to conceive of alternative realities and create plans that ......
...
#size16#Source: #bold#Farnam Street#/color##size20#
#size16##colorgrey#READING TIME: 2 MINUTES#/color##size20##/bold#
%%image%%#linkhttps://miro.medium.com/max/954/1*R1zMS-MZESF36fiKshoOsQ.png##aligncenter##width0.3##height0.15#
%%normal%%
#size20#
...
%%quote%%
  #size25#“It is our knowledge — the things we are sure of — that makes the world go wrong and keeps us from seeing and learning.”
  
  — #italic##colorgrey##size20#Lincoln Steffens
%%normal%%

#size20#Some questions are only asked by people with a fundamental misunderstanding. The friends who walk into my office and ask, “have you read all of these” miss the point of books.
...
%%quote%%
  #size20#The writer Umberro Eco belongs to that small class of scholars who are encyclopedic, insightful, and nondull. He is the owner of a large personal library (containing thirty thousand books), and separates visitors into two categories: those who react with “Wow! Signore professore dottore Eco, what a library you have. How many of these books have you read?” and the others—a very small minority—who get the point is that a private library is not an ego-boosting appendages but a research tool. #bold#The library should contain as much of what you do not know as your financial means … allow you to put there.#/bold# You will accumulate more knowledge and more books as you grow older, and the growing number of unread books on the shelves will look at you menacingly. #bold#Indeed, the more you know, the larger the rows of unread books. Let us call this collection of unread books an antilibrary.#/bold#
%%normal%%

#size20#Taleb adds:

%%quote%%
  #size20#We tend to treat our knowledge as personal property to be protected and defended. It is an ornament that allows us to rise in the pecking order. So this tendency to offend Eco’s library sensibility by focusing on the known is a human bias that extends to our mental operations. People don’t walk around with anti-résumés telling you what they have not studied or experienced (it’s the job of their competitors to do that), but it would be nice if they did. Just as we need to stand library logic on its head, we will work on standing knowledge itself on its head.
%%normal%%

#size20#A good library is filled with mostly unread books. That’s the point. Our relationship with the unknown causes the very problem Taleb is famous for contextualizing: the black swan. Because we underestimate the value of what we don’t know and overvalue what we do know, we fundamentally misunderstand the likelihood of surprises.
...
String cargoCultScience='''
 #linkhttp://calteches.library.caltech.edu/51/2/CargoCult.htm##size35##italic##bold#Cargo Cult Science#/color##/link##/italic##/bold#

#italic##colorgrey##size20#by RICHARD P. FEYNMAN
#/color##/italic#
...
String betterWriter= '''
 #linkhttps://dilbertblog.typepad.com/the_dilbert_blog/2007/06/the_day_you_bec.html##size35##italic##bold#The Day You Became A Better Writer#/color##/link##/italic##/bold#

#italic##colorgrey##size20#by Scott Adams
#/color##/italic#
...
String howToBeSuccessful='''
#size35##bold#How To Be Successful#/bold#
...
#bold#3. Learn to think independently#/bold#
...
#bold#5. Make it easy to take risks#/bold#
...
#bold#10. Be hard to compete with#/bold#
...
#bold#12. You get rich by owning things#/bold#
...
#bold#13. Be internally driven#/bold#
...
// "quo": '''
//     "Quote Quote Nature is full of patterns and humans have evolved to be amazing pattern recognizers 
...
//     \n\n
//     ''',
//     "Gettysburg Address":'''#italic##size12##fontfamMontserrat#Four score an#fw700#d seven years ago#fw400# our fathers brought forth on this continent a new nation, conceived in Liberty, and #fw700#dedicated to the proposition#fw400# that all men are created equal.
// Now we are engaged in a great civil war, testing whether that nation or any nation so conceived and so dedicated, can long endure. We are met on a great battle-field of that war. We have come to dedicate a portion of that field, as a f#size14#inal resting place for th#size12#ose who here gave their lives that that nation might live. It is altogether fitting and proper that we should do this.
...
// "Antilibrary":'''
// #italic##bold##size35#The Antilibrary: Why Unread Books Are The Most Important#/italic##/bold#
// #size16##colorgrey#READING TIME: 2 MINUTES#/color##size20#
